package com.bankproject.accounts.controller;
...
import com.bankproject.accounts.dto.ResponseDto;
...
public class AccountsController {
    ...
    @Operation(
            ...
            description = "REST API to create new Customer and Account inside easy bank"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "201",
